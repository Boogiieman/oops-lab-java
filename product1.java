...
String pname;
double price;
product1(int code,String name,double price1)
{
pcode=code;
pname=name;
price=price1;
...
pname1=s.next();
pprice1=s.nextFloat();
product1 obj1=new product1(pcode1,pname1,pprice1);
System.out.println("Enter the product 2 details:");
pcode2=s.nextInt();
pname2=s.next();
price2=s.nextFloat();
product1 obj2=new product1(pcode2,pname2,price2);
System.out.println("Enter the product 3 details:");
pcode3=s.nextInt();
pname3=s.next();
price3=s.nextFloat();
product1 obj3=new product1(pcode3,pname3,price3);
